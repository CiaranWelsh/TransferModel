      ...
      <MiriamAnnotation>
        <rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
          <rdf:Description rdf:about="#Function_6">
            <dcterms:created>
              <rdf:Description>
                <dcterms:W3CDTF>2019-11-26T22:05:21Z</dcterms:W3CDTF>
              </rdf:Description>
            </dcterms:created>
          </rdf:Description>
        </rdf:RDF>
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
  ...
  <Model key="Model_1" name="NoName" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m&#178;" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221417899999999e+23">
    ...
    <ListOfReactions>
      ...
      <Reaction key="Reaction_1" name="R1Out" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_5012" name="_kIRS1Out" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_3" name="R2f" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_5008" name="_kIRS1Phos_kcat" value="1"/>
          <Constant key="Parameter_5007" name="_kIRS1Phos_km" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_4" name="R3f" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_5006" name="_kPI3KPhos_kcat" value="1"/>
          <Constant key="Parameter_5005" name="_kPI3KPhos_km" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_6" name="R4f" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_5003" name="_kAktPhos_kcat" value="1"/>
          <Constant key="Parameter_5002" name="_kAktPhos_km" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_7" name="R4In" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_5001" name="v" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=NoName,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
      ...
      <Reaction key="Reaction_9" name="R4b" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4999" name="_kAktDephos" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_10" name="R5f" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4998" name="_kTSC2Phos_kcat" value="1"/>
          <Constant key="Parameter_4997" name="_kTSC2Phos_km" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_12" name="R5In" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4995" name="v" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=NoName,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
      ...
      <Reaction key="Reaction_14" name="R6f" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4993" name="AA" value="1"/>
          <Constant key="Parameter_4992" name="_kmTORC1cytToLys" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_16" name="R7f" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4990" name="_kmTORC1Phos_kcat" value="1"/>
      ...
      <Reaction key="Reaction_18" name="R8In" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4987" name="v" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=NoName,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
      ...
      <Reaction key="Reaction_20" name="R8f" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4985" name="_kPras40Phos_kcat" value="1"/>
          <Constant key="Parameter_4984" name="_kPras40Phos_km" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_21" name="R8b" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4983" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=NoName,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
      ...
      <Reaction key="Reaction_22" name="R9In" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4982" name="v" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=NoName,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
      ...
      <Reaction key="Reaction_24" name="R9f" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4980" name="_kFourEBP1Phos_kcat" value="1"/>
          <Constant key="Parameter_4979" name="_kFourEBP1Phos_km" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_27" name="R10f" reversible="false" fast="false" addNoise="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4976" name="_kS6KPhos_kcat" value="1"/>
          <Constant key="Parameter_4975" name="_kS6KPhos_km" value="1"/>
        </ListOfConstants>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Scan" type="scan" scheduled="true" updateModel="0">
      <Report append="0" target="/home/ncw135/Documents/MesiSTRAT2/TransferModel/transfer_model/models/Problem5_MMRateLaws/Fit1/simple_akt_model/ParameterEstimationData/PEData0.txt" reference="Report_71" confirmOverwrite="0"/>
      <Problem>
